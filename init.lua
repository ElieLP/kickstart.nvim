...
-- Add session options for auto-session
...
-- Custom function to open multiple files in telescope
...
require('lazy').setup({
  ...
  {
    'NvChad/nvim-colorizer.lua', -- Colorize hexadecimal colors
    config = function()
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'json', 'jsonc', 'hyprlang' },
